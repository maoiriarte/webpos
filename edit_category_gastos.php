<?php
  ...
  if(isset($_POST['btn_edit'])){
      ...
      $update = $pdo->prepare("UPDATE tbl_category_gastos SET cat_name='$category_name' WHERE cat_id='".$_GET['id']."' ");
  ...
  if($id=$_GET['id']){
    $select = $pdo->prepare("SELECT * FROM tbl_category_gastos WHERE cat_id = '".$_GET['id']."' ");
    $select->execute();
            ...
            <div class="box box-warning">
                ...
                <form action="" method="POST">
                  ...
                  <div class="box-footer">
                      ...
                      <a href="category_gastos.php" class="btn btn-warning">Volver</a>
                  </div>
                </form>
            </div>
      </div>
