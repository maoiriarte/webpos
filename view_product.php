              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><b>Precio de compra</b>  :<span class="label label-warning pull-right">COP. <?php if($_SESSION['role']=="Admin"){ echo number_format($row->purchase_price); }else{echo '--'; }?></span></li>
                    ...
                    <li class="list-group-item"><b>Ganancia</b>           :<span class="label label-success pull-right">COP. <?php if($_SESSION['role']=="Admin"){ echo number_format(($row->sell_price - $row->purchase_price)); }else{echo '--'; }?></span></li>
                    <li class="list-group-item"><b>Stock </b>          :<span class="label label-default pull-right"><?php echo $row->stock; ?></span></li>
                    <li class="list-group-item"><b>Stock Minimo </b>   :<span class="label label-default pull-right"><?php echo $row->min_stock; ?></span></li>
