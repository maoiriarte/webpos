<?php
    ...
    if(isset($_POST['update_product'])){
        ...
        $desc_req = $_POST['description'];
                ...
                if($img_ext == 'jpg' || $img_ext == 'jpeg' || $img_ext == 'png' || $img_ext == 'gif'){
                    if($img_size>= 1000000){
                        $error ='<script type="text/javascript">
                                ...
                                swal.fire("Error", "File Tidak Lebih Dari 1MB", "error", {
                                button: "Continue",
                                    });
                                });
                                </script>';
                        ...
                        if(move_uploaded_file($img_tmp,$store)){
                            ...
                            if(!isset($error)){
                                ...
                                product_category=:product_category, purchase_price=:purchase_price, sell_price=:sell_price, utilidad=:utilidad,
                                stock=:stock,min_stock=:min_stock,description=:description, img=:img WHERE product_id=$id");
                                ...
                                $update->bindParam('utilidad',$uti_req);
                ...
                $update->bindParam('purchase_price', $purchase_req);
                $update->bindParam('sell_price', $sell_req);                
                $update->bindParam('utilidad', $uti_req = $sell_req - $purchase_req);
                $update->bindParam('stock', $stock_req);
                $update->bindParam('min_stock', $min_stock_req);
                $update->bindParam('description', $desc_req);
                ...
                if($update->execute()){
                    ...
                    jQuery(function validation(){
                    swal("Success", "Producto actualizado con exito", "success", {
                    button: "Continuar",
                        });
                    });
                    </script>';
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                            name="product_name" maxlength="28" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $productName_db; ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                            class="form-control"
                            name="utilidad" value="<?php echo $uti_db = $sell_db - $purchase_db; ?>" required readonly>
                        </div>
                    </div>
